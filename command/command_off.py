"""
    Clase para ejecutar el command switch_off (apagado), cada vez que se quiera encender el objeto, no importar que objeto, se usa
    esta clase
"""

from interface import ICommand

class SwithOffCommand(ICommand):
